...
// カードタイプＡの設定値
var setProtocolBuffer_typeA  = new Uint8Array([0x00, 0x00, 0xff, 0xff, 0xff, 0x28, 0x00, 0xd8, 0xd6, 0x02, 0x00, 0x06, 0x01, 0x00, 0x02, 0x00, 0x03, 0x00, 0x04, 0x00, 0x05, 0x01, 0x06, 0x00, 0x07, 0x07, 0x08, 0x00, 0x09, 0x00, 0x0a, 0x00, 0x0b, 0x00, 0x0c, 0x00, 0x0e, 0x04, 0x0f, 0x00, 0x10, 0x00, 0x11, 0x00, 0x12, 0x00, 0x13, 0x06, 0x5f, 0x00]);
//reqa
var setProtocolBuffer_read00 = new Uint8Array([0x00, 0x00, 0xff, 0xff, 0xff, 0x0a, 0x00, 0xf6, 0xd6, 0x02, 0x01, 0x01, 0x02, 0x01, 0x04, 0x01, 0x07, 0x08, 0x0f, 0x00]);
					...
					// Port-100チップのコマンドタイプを設定する命令
						...
						// Port-100チップとFelicaカードとの通信速度およびカードタイプを指定する命令
							...
							// 通信対象のカードタイプの通信プロトコルを設定する命令
			       				send_recieve_packet_RCS380(handle, setProtocolBuffer_typeA).then(function(){
